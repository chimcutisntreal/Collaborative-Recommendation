...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btTabImportData.setGeometry(QtCore.QRect(0, 0, 240, 31))
        ...
        self.btTabNhomNguoiCongTac.setGeometry(QtCore.QRect(241, 0, 240, 31))
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tblP1.setHorizontalHeaderItem(3, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.tblP1.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Xem bài báo"))
